...
|----|-----------------------|--------------|----------|----------------|
| 1 | 💻 **Pilas en Java** | Implementación de una pila genérica con interfaz `IStack`, clase `StackArray` y clase de prueba `MainStack`. | [`Ver Documento`](Ejercicios-Guiados/Código/pilas/IStack.java) | Pilas y estructuras LIFO |
